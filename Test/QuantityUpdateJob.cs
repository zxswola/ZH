...
namespace Test
{
    public class QuantityUpdateJob : IJob
    {
        ...
        private static log4net.ILog log = log4net.LogManager.GetLogger(typeof(QuantityUpdateJob));
        ...
        public void GetUpdateList(ItemsItem item)
        {
            ...
            foreach (var itemDetail in itemDetails)
            {
                ...
                listUpdateData.Add(new DYGoods {ItemID = item.item_id, Qty = qty, ItemSku = itemDetail.sku_id.ToString()});
            }
